          ...
          {!showForgotPassword ? (
            <>
              ...
              <div className="signup-link" style={{ textAlign: 'center', marginTop: '15px' }}>
                <p style={{ fontSize: '14px', color: 'rgba(88, 87, 87, 0.822)', }}>
                  Don't have an account? <Link to="/signup" style={{ color: '#283593', fontWeight: '600', textDecoration: 'none' }}>Sign Up</Link>
                </p>
              </div>
            </>
          ) : (
